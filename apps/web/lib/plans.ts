...
export const PLANS: PlanInfo[] = [
  ...
  { id: "SENIOR", label: "Senior", month: 39.9, year: 438.9, crosses: "1 por dia", images: "Retrato em todo cruzamento + 15 retratos extras/mês", tools: "Escolhe entre 6 opções de fenótipo", pool: "+ Caninos", accent: "#BF00FF", featured: true },
  { id: "PHD", label: "PhD", month: 89.9, year: 988.9, crosses: "3 por dia", images: "Retrato em todo cruzamento + 20 retratos extras/mês", tools: "Escolhe entre 12 opções de fenótipo", pool: "Todas as espécies do catálogo (gatos, felinos selvagens e cães)", accent: "#F5C542" },
];
