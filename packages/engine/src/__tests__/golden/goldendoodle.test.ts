...
const A = { id: "golden", genotype: GOLDEN_RETRIEVER, generation: 0, sex: "M" as const, species: "canis-familiaris" };
const B = { id: "poodle", genotype: POODLE, generation: 0, sex: "F" as const, species: "canis-familiaris" };
