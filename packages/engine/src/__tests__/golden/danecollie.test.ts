...
const omega = { id: "omegaII", genotype: OMEGA_II, generation: 2, sex: "M" as const, species: "canis-familiaris" };
const beta = { id: "beta", genotype: DANECOLLIE_BETA, generation: 1, sex: "F" as const, species: "canis-familiaris" };
