...
| Arquivo | Papel |
|---|---|
| `docs/adr/` | Decisões de arquitetura/regra. **Fonte mais recente** (ADR-0001 a 0034) |
...
Template em `docs/adr/0000-template.md`; arquivos `docs/adr/00NN-titulo.md` (próximo: 0035). Formato mínimo: Contexto
